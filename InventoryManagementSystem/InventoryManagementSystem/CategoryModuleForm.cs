    ...
    public partial class CategoryModuleForm : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    cmd = new SqlCommand("INSERT INTO tbCategory(catname)VALUES(@catname)", conDB);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    cmd = new SqlCommand("UPDATE tbCategory SET catname=@catname WHERE catid LIKE '" + lblCatId.Text + "'", conDB);
                    cmd.Parameters.AddWithValue("@catname", txtCatName.Text);
                    conDB.Open();
                    cmd.ExecuteNonQuery();
                    conDB.Close();
